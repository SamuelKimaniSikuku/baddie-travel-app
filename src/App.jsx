...
// ─── ACTIVATION CODES (SHA-256 hashes of normalized codes) ──────────────────
  ...
  return (
    <div className="fade">
      ...
      <div style={{background:"white",borderRadius:16,padding:"24px",boxShadow:"0 2px 16px rgba(0,0,0,.06)"}}>
        ...
        {[["Comment recevoir mon code d'activation ?","Après votre paiement Stripe, vous recevez un reçu par email avec votre code. Entrez-le dans l'onglet 'J'ai un code' ou sur la page Tarifs."],["Qu'est-ce que l'accès à vie ?","Vous payez une seule fois et accédez au contenu pour toujours, sur le même navigateur."],["Le paiement est-il sécurisé ?","Oui, le paiement est géré par Stripe, leader mondial du paiement en ligne."],["Puis-je obtenir une facture ?","Stripe envoie automatiquement un reçu détaillé par email."],["Combien y a-t-il de questions ?",`Le programme contient ${ALL_QUESTIONS.length} questions couvrant les 5 thèmes officiels.`]].map(([q,a])=>(
